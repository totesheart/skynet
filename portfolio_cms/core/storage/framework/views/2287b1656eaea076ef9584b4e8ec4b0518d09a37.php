                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1"><?php echo e(__('Edit Language Keyword')); ?></h3>
                            ...
                            <form method="post" action="<?php echo e(route('admin.language.updateKeyword', $la->id)); ?>" id="langForm">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 mt-3">
                                        <button type="submit" class="btn btn-success btn-block btn-lg"><?php echo e(__('Update')); ?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\local\liveporichoy\core\resources\views/admin/language/edit-keyword.blade.php ENDPATH**/ ?>