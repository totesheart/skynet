      ...
      <div class="card-body login-card-body text-center">
        ...
        <form action="<?php echo e(route('admin.auth')); ?>" method="POST">
          ...
          <div class="row">
            <!-- /.col -->
            <div class="col-12">
              <button type="submit" class="btn btn-success btn-block"><?php echo e(__('LOGIN')); ?></button>
            </div>
            <!-- /.col -->
          </div>
        </form>
...
<?php /**PATH C:\laragon\www\porichoy\core\resources\views/admin/login.blade.php ENDPATH**/ ?>