        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="section-title ">
                    <h2 class=""><?php echo e($setting->portfolio_title); ?></h2>
                    <span class=""><?php echo e($setting->portfolio_title); ?></span>
                </div>
            </div>
        </div>
...
<!-- Portfolio Area End -->
<?php endif; ?><?php /**PATH C:\laragon\www\pfolio-new\core\resources\views/front/partials/section-partials/portfolio.blade.php ENDPATH**/ ?>