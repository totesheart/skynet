            ...
            <div class="col-lg-12">
                <div class="card  card-success card-outline">
                    <div class="card-header">
                        <h3 class="card-title mt-1"><?php echo e(__('Add Pricing Plan')); ?></h3>
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="<?php echo e(route('admin.pricing.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" name="currency" value="<?php echo e(old('currency')); ?>" placeholder="<?php echo e(__('Enter Currency')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" name="price" value="<?php echo e(old('price')); ?>" placeholder="<?php echo e(__('Enter Price')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" name="plan_name" value="<?php echo e(old('plan_name')); ?>" placeholder="<?php echo e(__('Plan Name')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea name="content" class="form-control textarea"  rows="4" placeholder="<?php echo e(__('Write Content')); ?>"><?php echo e(old('content')); ?></textarea>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\local\liveporichoy\core\resources\views/admin/pricing/create.blade.php ENDPATH**/ ?>