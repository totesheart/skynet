                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    <img src="<?php echo e(asset('assets/admin/img/agency.jpg')); ?>" alt=""
                                                         style="width:100%;">
                                                    <h4 class="text-center mt-3 mb-0">Agency</h4>
                                                </div>
                                                <div class="card-footer text-center">
                                                    ...
                                                    <?php else: ?>
                                                        <form class="deleteform d-inline-block"
                                                              ...
                                                              method="post">
                                                            <?php echo csrf_field(); ?>
                                                            <input type="hidden" name="themes" value="agency">
                                                            <button type="submit"
                                                                    class="btn btn-info btn-sm confirmbtn">
                                                                      <span class="btn-label">
                                                                        <i class="fas fa-arrow-alt-circle-down"></i>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\porichoy\core\resources\views/admin/settings/themes.blade.php ENDPATH**/ ?>