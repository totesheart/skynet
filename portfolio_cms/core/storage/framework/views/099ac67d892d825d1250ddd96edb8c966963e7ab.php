                        ...
                        <div class="card-body"> 
                                <form class="form-horizontal" action="<?php echo e(route('admin.contact_info_update')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                        ...
                                        <div class="form-group row">
                                            <label for="latitude" class="col-sm-2 control-label"> <?php echo e(__('Latitude')); ?> <span class="text-danger">*</span>  </label>
            
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="latitude" value="<?php echo e($about->latitude); ?>">
                                                <?php if($errors->has('latitude')): ?>
                                                    <p class="text-danger"> <?php echo e($errors->first('latitude')); ?> </p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="longitude" class="col-sm-2 control-label"> <?php echo e(__('Longitude')); ?> <span class="text-danger">*</span>  </label>
            
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="longitude" value="<?php echo e($about->longitude); ?>">
                                                <?php if($errors->has('longitude')): ?>
                                                    <p class="text-danger"> <?php echo e($errors->first('longitude')); ?> </p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="form-group row">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\liveporichoy\core\resources\views/admin/about/contact-info.blade.php ENDPATH**/ ?>