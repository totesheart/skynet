			...
			<nav class="navbar navbar-expand-lg navbar-light">
				...
				<div class="collapse navbar-collapse" id="ca-navbar">
					<ul class="navbar-nav ml-auto" id="nav">
						...
						<?php if($setting->themes == 'default' || $setting->themes == 'agency'): ?>
						...
						<?php if($setting->themes == 'agency' ): ?>
							...
							<li class="nav-item">
								<a class="nav-link" href="<?php if(request()->path() == '/'): ?> #pricing <?php else: ?> <?php echo e(route('front.index')); ?>#pricing <?php endif; ?>"><?php echo e(__('Pricing')); ?></a>
							</li>
							<?php endif; ?>
						<?php endif; ?>

						<?php if($setting->themes == 'default' || $setting->themes == 'portfolio'): ?>
							<?php if($setting->istestimonial == 1): ?>
							<li class="nav-item">
								<a class="nav-link" href="<?php if(request()->path() == '/'): ?> #testimonial <?php else: ?> <?php echo e(route('front.index')); ?>#testimonial <?php endif; ?>"><?php echo e(__('Testimonial')); ?></a>
							</li>
							<?php endif; ?>
						<?php endif; ?>
						...
						<?php if($setting->themes == 'resume' || $setting->themes == 'portfolio'): ?>
							<?php if($setting->iscontact == 1): ?>
							<li class="nav-item">
								<a class="nav-link" href="<?php if(request()->path() == '/'): ?> #contact <?php else: ?> <?php echo e(route('front.index')); ?>#contact <?php endif; ?>"><?php echo e(__('Contact')); ?></a>
							</li>
							<?php endif; ?>
						<?php endif; ?>

					</ul>
					<div class="lanwrapper d-none d-lg-block">
						<?php if(count($langs) > 0): ?>
                       
                       <div class="language">
                          <a class="language-btn" href="#">
							 <?php echo e($currentLang->name); ?>
                          ...
                          <ul class="language-dropdown">
							...
							<li><a href='<?php echo e(route('changeLanguage', $lang->code)); ?>'>
...
</html><?php /**PATH C:\laragon\www\liveporichoy\core\resources\views/front/layout.blade.php ENDPATH**/ ?>