                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                                <textarea name="content" class="form-control textarea" rows="4" placeholder="{{ __('Content') }}">{{ $blog->content }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="share_code" class="form-control" rows="4"  placeholder="{{ __('Enter Your Embade Code') }}">{{ $blog->share_code }}</textarea>
