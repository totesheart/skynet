            ...
            <div class="col-lg-12">
                <div class="card  card-success card-outline">
                    <div class="card-header">
                        <h3 class="card-title mt-1">{{ __('Add Pricing Plan') }}</h3>
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin.pricing.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" name="currency" value="{{ old('currency') }}" placeholder="{{ __('Enter Currency') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" name="price" value="{{ old('price') }}" placeholder="{{ __('Enter Price') }}">
                                            @if ($errors->has('price'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" name="plan_name" value="{{ old('plan_name') }}" placeholder="{{ __('Plan Name') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea name="content" class="form-control textarea"  rows="4" placeholder="{{ __('Write Content') }}">{{ old('content') }}</textarea>
