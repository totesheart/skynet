                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="bcategory_id">
                                                ...
                                                <option value="{{ $bcategory->id }}" selected>{{ $bcategory->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                                <textarea name="content" class="form-control textarea" id="ck" placeholder="{{ __('Content') }}">{{ old('content') }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        <label for="title" class="col-sm-2 control-label">{{ __('Share Code') }} <br> <small>( CodePen embed link )</small></label>

                                        <div class="col-sm-10">
                                            <textarea name="share_code" class="form-control" rows="4"  placeholder="{{ __('Enter Your Embade Code') }}">{{ old('share_code') }}</textarea>
