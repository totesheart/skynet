            ...
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            <div class="card-header  with-border">
                                <h3 class="card-title mt-1"><?php echo e(__('Edit Skill')); ?></h3>
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="<?php echo e(route('admin.skill.update', $skill->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                            ...
                                            <select class="form-control" name="scategory_id">
                                                ...
                                                <?php $__currentLoopData = $scategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($scategory->id); ?>" 
                                                        <?php echo e($scategory->id == $skill->scategory_id ? 'selected' : ''); ?>

                                                        ><?php echo e($scategory->name); ?></option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="name" placeholder="<?php echo e(__('Name')); ?>" value="<?php echo e($skill->name); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="level" placeholder="<?php echo e(__('Level')); ?>" value="<?php echo e($skill->level); ?>">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\porichoy\core\resources\views/admin/skill/edit.blade.php ENDPATH**/ ?>