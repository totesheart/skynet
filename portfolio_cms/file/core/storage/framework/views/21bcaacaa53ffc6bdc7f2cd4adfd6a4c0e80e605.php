        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="section-title">
                    <h2 class=""><?php echo e($setting->faq_title); ?></h2>
                </div>
            </div>
        </div>
        <div class="row">
...
<!-- Blog Area End -->
<?php endif; ?><?php /**PATH C:\laragon\www\pfolio-new\core\resources\views/front/partials/section-partials/faq.blade.php ENDPATH**/ ?>