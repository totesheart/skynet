        ...
        <div class="row">
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="<?php echo e(route('admin.service.store')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group row">
                                        <label for="description" class="col-sm-2 control-label"><?php echo e(__('Short Description')); ?><span class="text-danger">*</span></label>
        
                                        <div class="col-sm-10">
                                            <textarea name="description" class="form-control" placeholder="<?php echo e(__('Short Description')); ?>" rows="3"><?php echo e(old('title')); ?></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="content" class="form-control textarea" placeholder="<?php echo e(__('Content')); ?>" rows="3"><?php echo e(old('content')); ?></textarea>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\local\liveporichoy\core\resources\views/admin/service/add.blade.php ENDPATH**/ ?>