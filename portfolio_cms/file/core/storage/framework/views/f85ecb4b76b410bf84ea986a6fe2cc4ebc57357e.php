                        ...
                        <table id="idtable" class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('admin.deleteSlinks', $slink->id )); ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i>Delete</a>
                                </td>
                            </tr>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\local\liveporichoy\core\resources\views/admin/settings/social/index.blade.php ENDPATH**/ ?>