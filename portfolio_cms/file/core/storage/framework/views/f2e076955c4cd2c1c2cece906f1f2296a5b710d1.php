    ...
    <div class="sidebar pt-0 mt-0">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('admin.message')); ?>" class="nav-link
            <?php if(request()->path() == 'admin/message'): ?> active 
            <?php elseif(request()->path() == 'admin/message/view'): ?> active 
            <?php endif; ?>">
...
<?php /**PATH C:\xampp\htdocs\local\liveporichoy\core\resources\views/admin/partials/side-navbar.blade.php ENDPATH**/ ?>