            ...
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-tools">
                        <a href="<?php echo e(route('admin.testimonial.add')); ?>" class="btn btn-primary btn-sm">
                    ...
                    <table id="idtable" class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <td width="18%">
                                ...
                                <a href="<?php echo e(route('admin.testimonial.delete', $testimonial->id )); ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i><?php echo e(__('Delete')); ?></a>
                            </td>
                        </tr>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\local\liveporichoy\core\resources\views/admin/testimonial/index.blade.php ENDPATH**/ ?>