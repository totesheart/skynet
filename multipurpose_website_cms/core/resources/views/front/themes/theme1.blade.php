...
@section('content')
    ...
    <div class="meet-us-area">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="meet-us-item bg_cover d-flex align-items-center justify-content-between" style="background-image: url({{ asset('assets/front/img/'.$sinfo->meeet_us_bg_image ) }}">
                        <h2 class="title">{{ $sinfo->meeet_us_text }}</h2>
                        <a class="main-btn" href="{{ $sinfo->meeet_us_button_link }}">{{ $sinfo->meeet_us_button_text }}<i class="fal fa-long-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--====== BRAND 2 PART START ======-->
    @if($commonsetting->is_t1_clint_section == 1)
