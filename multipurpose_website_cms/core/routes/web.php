...
Route::group(['middleware' => 'setlang'], function () {
    ...
    Route::get('/portfolio', 'Front\FrontendController@portfolio')->name('front.portfolio');
    Route::get('/portfolio/{slug}', 'Front\FrontendController@portfolio_details')->name('front.portfolio.details');
