...
<?php $__env->startSection('content'); ?>
    ...
    <div class="meet-us-area">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="meet-us-item bg_cover d-flex align-items-center justify-content-between" style="background-image: url(<?php echo e(asset('assets/front/img/'.$sinfo->meeet_us_bg_image )); ?>">
                        <h2 class="title"><?php echo e($sinfo->meeet_us_text); ?></h2>
                        <a class="main-btn" href="<?php echo e($sinfo->meeet_us_button_link); ?>"><?php echo e($sinfo->meeet_us_button_text); ?><i class="fal fa-long-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--====== BRAND 2 PART START ======-->
    <?php if($commonsetting->is_t1_clint_section == 1): ?>
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\multipurpose_website-test\core\resources\views/front/themes/theme1.blade.php ENDPATH**/ ?>